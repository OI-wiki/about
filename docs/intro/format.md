...
-   逻辑性。
    ...
    -   对于算法或数学概念类内容的撰写应该尽量包含以下的内容：
        ...
        示例页面：[IDA\*](https://github.com/OI-wiki/OI-wiki/blob/master/docs/search/idastar.md)
    ...
    -   对于工具类内容的撰写应该尽量包含以下的内容：
        ...
        示例页面：[WSL (Windows 10)](https://github.com/OI-wiki/OI-wiki/blob/master/docs/tools/wsl.md)
...
-   涉及到“前置知识”的页面，请在开头添加一行 **前置知识：……**，放在页面概述前。格式如下：
    ...
    > 前置知识：[时间复杂度](https://github.com/OI-wiki/OI-wiki/blob/master/docs/misc/complexity.md)
    >
    > 本页面将介绍基础的计算理论的知识。
